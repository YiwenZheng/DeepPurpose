...
from utils import generate_config, idx2word_d
...
def get_parser():
    ...
    parser.add_argument("-d_e", "--drug_encoding", type = str, default = "ESPF",\
        required = False, help = "Drug encoding")
    parser.add_argument("--input_dim_drug", type = int, default = len(idx2word_d),\
